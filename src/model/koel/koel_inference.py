"""KoelLabs XLSR inference adapter compatible with distributed inference API."""
...
class KoelInference:
    """Greedy CTC inference wrapper for KoelLabs XLSR checkpoints."""
    ...
    def _id_to_token(self, token_id: int) -> str:
        ...
        if isinstance(id2label, dict):
            ...
            if token is None:
                token = id2label.get(str(token_id))
