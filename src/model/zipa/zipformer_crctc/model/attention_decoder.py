...
class AttentionDecoderModel(nn.Module):
    """Attention Decoder Model for Zipformer-CRCTC.
    ...
    def forward(self, **inputs):
        raise NotImplementedError(
            "Fix k2 and icefall dependencies for transducer. For delta ai do https://k2-fsa.github.io/k2/installation/from_source.html, else use a prebuilt wheel for x86_64!"
        )
