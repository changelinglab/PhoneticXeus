...
def build_xeus_pr(
    ...
    interctc_layer_idx: Optional[list] = (4, 8, 12),
    ...
    if interctc_layer_idx:
        encoder_conf["interctc_layer_idx"] = list(interctc_layer_idx)
    ...
    if checkpoint:
        ...
        assert not load_info.unexpected_keys, load_info.unexpected_keys
